...
def train(args):
    ...
    # expand vocab size by NUM_RESERVED_TOKENS, to accomadate for left, right arrow tokens
    ...
    plot_probs(os.path.join(out_dir, 'probs.npy'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='exp_reverse_probs') 
